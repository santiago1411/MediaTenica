    ...
    <div className="header">
      ...
      <nav className="navbar navbar-expand-lg bg-body-tertiary">
        <div className="container-fluid">
          <Link className="navbar-brand" to="/">La Salle</Link>
      ...
      <div className="p-3">
        <div className="card">
          ...
          <div className="card-body">
            <h5 className="encabezado">La Sallo Campo Amor</h5>
            <p className="card-text"><strong>100%</strong> De los estudiantes, se graduan de 11.</p>
          </div>
        </div>
      </div>
